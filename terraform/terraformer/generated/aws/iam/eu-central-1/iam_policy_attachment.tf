...
resource "aws_iam_policy_attachment" "AWSDataLifecycleManagerServiceRole" {
  ...
  roles      = ["AWSDataLifecycleManagerServiceRole"]
}
...
resource "aws_iam_policy_attachment" "AWSDirectoryServiceReadOnlyAccess" {
  ...
  roles      = ["gluon-asu", "ec2-infra", "generic-admin-tool", "ec2_readonly", "gluon-yes-asu", "admin-portal-3"]
}
...
resource "aws_iam_policy_attachment" "AWSElasticBeanstalkService" {
  ...
  roles      = ["aws-elasticbeanstalk-service-role"]
  users      = ["teamcity", "elasticbeanstalk-deploy"]
}
...
resource "aws_iam_policy_attachment" "AWSLambdaBasicExecutionRole-3f87559a-531c-4789-b832-2b77f0d84004" {
  name       = "AWSLambdaBasicExecutionRole-3f87559a-531c-4789-b832-2b77f0d84004"
  policy_arn = "arn:aws:iam::633944440063:policy/service-role/AWSLambdaBasicExecutionRole-3f87559a-531c-4789-b832-2b77f0d84004"
}

resource "aws_iam_policy_attachment" "AWSLambdaBasicExecutionRole-860293ab-83d3-4289-8531-6d3432a27fbd" {
  name       = "AWSLambdaBasicExecutionRole-860293ab-83d3-4289-8531-6d3432a27fbd"
  policy_arn = "arn:aws:iam::633944440063:policy/service-role/AWSLambdaBasicExecutionRole-860293ab-83d3-4289-8531-6d3432a27fbd"
  roles      = ["war-gamelift-newlogs-notify-role"]
}

resource "aws_iam_policy_attachment" "AWSLambdaBasicExecutionRole-f4003612-3fa9-4be2-93bc-be77e983fdd7" {
  name       = "AWSLambdaBasicExecutionRole-f4003612-3fa9-4be2-93bc-be77e983fdd7"
  policy_arn = "arn:aws:iam::633944440063:policy/service-role/AWSLambdaBasicExecutionRole-f4003612-3fa9-4be2-93bc-be77e983fdd7"
  roles      = ["owp-rewards-lambda"]
}
...
resource "aws_iam_policy_attachment" "AWSLambdaMicroserviceExecutionRole-604d5eb8-6e3a-4f75-ae36-1d1c10bb0051" {
  name       = "AWSLambdaMicroserviceExecutionRole-604d5eb8-6e3a-4f75-ae36-1d1c10bb0051"
  policy_arn = "arn:aws:iam::633944440063:policy/service-role/AWSLambdaMicroserviceExecutionRole-604d5eb8-6e3a-4f75-ae36-1d1c10bb0051"
  roles      = ["owp-rewards-lambda"]
}
...
resource "aws_iam_policy_attachment" "AWSLambdaS3ExecutionRole-70041fc0-bda6-425e-b58f-5c4d85d79c7c" {
  name       = "AWSLambdaS3ExecutionRole-70041fc0-bda6-425e-b58f-5c4d85d79c7c"
  policy_arn = "arn:aws:iam::633944440063:policy/service-role/AWSLambdaS3ExecutionRole-70041fc0-bda6-425e-b58f-5c4d85d79c7c"
  roles      = ["war-gamelift-newlogs-notify-role"]
}
...
resource "aws_iam_policy_attachment" "AWSQuickSightIAMPolicy" {
  name       = "AWSQuickSightIAMPolicy"
  policy_arn = "arn:aws:iam::633944440063:policy/service-role/AWSQuickSightIAMPolicy"
...
resource "aws_iam_policy_attachment" "AWSQuickSightS3Policy" {
  name       = "AWSQuickSightS3Policy"
  policy_arn = "arn:aws:iam::633944440063:policy/service-role/AWSQuickSightS3Policy"
  roles      = ["aws-quicksight-service-role-v0"]
  users      = ["quicksight-user"]
}
...
resource "aws_iam_policy_attachment" "AmazonEC2ContainerRegistryReadOnly" {
  ...
  roles      = ["locust-loadtest", "war-dev-gameplay-node", "war-test-worker-nodes-NodeInstanceRole-18S1WSSVK1146", "ec2_readonly"]
}
...
resource "aws_iam_policy_attachment" "AmazonEC2ReadOnlyAccess" {
  ...
  roles      = ["gluon-asu", "locust-loadtest", "generic-admin-tool", "unitytemplate-ecs", "ec2_readonly", "gluon-yes-asu", "war-admin", "admin-portal-3", "ec2-fluentd"]
}
...
resource "aws_iam_policy_attachment" "AmazonEKSClusterPolicy" {
  ...
  roles      = ["eks-manage", "war-dev-gameplay-cluster"]
}
...
resource "aws_iam_policy_attachment" "AmazonEKSWorkerNodePolicy" {
  ...
  roles      = ["war-dev-gameplay-node", "war-test-worker-nodes-NodeInstanceRole-18S1WSSVK1146"]
}
...
resource "aws_iam_policy_attachment" "AmazonS3FullAccess" {
  ...
  roles      = ["s3_ro_access_4_quicksight"]
  users      = ["rgutsenko"]
}

resource "aws_iam_policy_attachment" "AmazonS3ReadOnlyAccess" {
  groups     = ["war_client_eng"]
  name       = "AmazonS3ReadOnlyAccess"
  policy_arn = "arn:aws:iam::aws:policy/AmazonS3ReadOnlyAccess"
  roles      = ["ec2-infra", "s3_ro_access_4_quicksight", "locust-loadtest", "aws-s3-AD-RO"]
  users      = ["quicksight-user", "teamcity", "rgonta"]
}
...
resource "aws_iam_policy_attachment" "CloudhealthPolicy" {
  name       = "CloudhealthPolicy"
  policy_arn = "arn:aws:iam::633944440063:policy/CloudhealthPolicy"
}
...
resource "aws_iam_policy_attachment" "CodeBuildTrustPolicy-war-dev-1524238932134" {
  name       = "CodeBuildTrustPolicy-war-dev-1524238932134"
  policy_arn = "arn:aws:iam::633944440063:policy/service-role/CodeBuildTrustPolicy-war-dev-1524238932134"
  roles      = ["code-build-war-dev-service-role"]
}
...
resource "aws_iam_policy_attachment" "DYNAMODB-ap3" {
  name       = "DYNAMODB-ap3"
  policy_arn = "arn:aws:iam::633944440063:policy/DYNAMODB-ap3"
  roles      = ["admin-portal-3"]
}
...
resource "aws_iam_policy_attachment" "DynamoDB" {
  name       = "DynamoDB"
  policy_arn = "arn:aws:iam::633944440063:policy/DynamoDB"
}
...
resource "aws_iam_policy_attachment" "EC2-startstop" {
  name       = "EC2-startstop"
  policy_arn = "arn:aws:iam::633944440063:policy/EC2-startstop"
  roles      = ["ec2-infra"]
}
...
resource "aws_iam_policy_attachment" "FluentD-Kinesis" {
  name       = "FluentD-Kinesis"
  policy_arn = "arn:aws:iam::633944440063:policy/FluentD-Kinesis"
  roles      = ["ec2-fluentd"]
}

resource "aws_iam_policy_attachment" "GAMELIFT-infra" {
  name       = "GAMELIFT-infra"
  policy_arn = "arn:aws:iam::633944440063:policy/GAMELIFT-infra"
  roles      = ["ec2-infra"]
}

resource "aws_iam_policy_attachment" "GAMELIFT-policy" {
  name       = "GAMELIFT-policy"
  policy_arn = "arn:aws:iam::633944440063:policy/GAMELIFT-policy"
  roles      = ["gluon-asu"]
}

resource "aws_iam_policy_attachment" "GameLift" {
  name       = "GameLift"
  policy_arn = "arn:aws:iam::633944440063:policy/GameLift"
}

resource "aws_iam_policy_attachment" "GameLift-GameDesigners" {
  groups     = ["GameDesigners"]
  name       = "GameLift-GameDesigners"
  policy_arn = "arn:aws:iam::633944440063:policy/GameLift-GameDesigners"
}

resource "aws_iam_policy_attachment" "GameLift-Matchmaking" {
  groups     = ["developers"]
  name       = "GameLift-Matchmaking"
  policy_arn = "arn:aws:iam::633944440063:policy/GameLift-Matchmaking"
  users      = ["ademin", "pivko", "rgonta", "okrasovskaya"]
}

resource "aws_iam_policy_attachment" "GameLiftAdmin" {
  groups     = ["developers", "developers_admin"]
  name       = "GameLiftAdmin"
  policy_arn = "arn:aws:iam::633944440063:policy/GameLiftAdmin"
  users      = ["teamcity", "ademin", "pivko", "rgonta", "okrasovskaya", "gamelift_admin"]
}

resource "aws_iam_policy_attachment" "GameLiftPlayer" {
  name       = "GameLiftPlayer"
  policy_arn = "arn:aws:iam::633944440063:policy/GameLiftPlayer"
  users      = ["gamelift_player"]
}

resource "aws_iam_policy_attachment" "GameLiftRO" {
  groups     = ["war_client_eng"]
  name       = "GameLiftRO"
  policy_arn = "arn:aws:iam::633944440063:policy/GameLiftRO"
}
...
resource "aws_iam_policy_attachment" "IAM-PASS-ROLE" {
  name       = "IAM-PASS-ROLE"
  policy_arn = "arn:aws:iam::633944440063:policy/IAM-PASS-ROLE"
}

resource "aws_iam_policy_attachment" "IAMFullAccess" {
  name       = "IAMFullAccess"
  policy_arn = "arn:aws:iam::aws:policy/IAMFullAccess"
  users      = ["sshamkin", "nperevozchikov"]
}
...
resource "aws_iam_policy_attachment" "IAMUserChangePassword" {
  ...
  users      = ["tsinitsyna", "mtumin", "araida", "esizov", "szotova", "eakimov", "sshamkin", "ademin", "rgutsenko", "pivko", "rgonta", "dbalashova", "route53-manager", "mvoronov", "nperevozchikov", "okrasovskaya", "vpalto", "asergeyev", "kdomareva", "akozlov", "pkuznetsov", "falaeddin"]
}
...
resource "aws_iam_policy_attachment" "KinesisLogs-infra" {
  name       = "KinesisLogs-infra"
  policy_arn = "arn:aws:iam::633944440063:policy/KinesisLogs-infra"
  roles      = ["firehose_infra_role"]
}
...
resource "aws_iam_policy_attachment" "QuickSightSignUpPolicy" {
  name       = "QuickSightSignUpPolicy"
  policy_arn = "arn:aws:iam::633944440063:policy/QuickSightSignUpPolicy"
  users      = ["quicksight-user"]
}
...
resource "aws_iam_policy_attachment" "REPORTS-all" {
  name       = "REPORTS-all"
  policy_arn = "arn:aws:iam::633944440063:policy/REPORTS-all"
  roles      = ["ec2-infra"]
}

resource "aws_iam_policy_attachment" "ROUTE53-ddns-update" {
  name       = "ROUTE53-ddns-update"
  policy_arn = "arn:aws:iam::633944440063:policy/ROUTE53-ddns-update"
  roles      = ["gluon-asu", "ec2-infra", "locust-loadtest", "generic-admin-tool", "unitytemplate-ecs", "ec2_readonly", "gluon-yes-asu", "war-admin", "admin-portal-3", "ec2-fluentd"]
}
...
resource "aws_iam_policy_attachment" "ReadOnlyBilling" {
  name       = "ReadOnlyBilling"
  policy_arn = "arn:aws:iam::633944440063:policy/ReadOnlyBilling"
  users      = ["erovaev"]
}
...
resource "aws_iam_policy_attachment" "S3-gat" {
  name       = "S3-gat"
  policy_arn = "arn:aws:iam::633944440063:policy/S3-gat"
  roles      = ["gluon-asu", "generic-admin-tool"]
}

resource "aws_iam_policy_attachment" "S3-gat-player-state-dev" {
  name       = "S3-gat-player-state-dev"
  policy_arn = "arn:aws:iam::633944440063:policy/S3-gat-player-state-dev"
}

resource "aws_iam_policy_attachment" "S3-war-dev" {
  groups     = ["war_client_eng"]
  name       = "S3-war-dev"
  policy_arn = "arn:aws:iam::633944440063:policy/S3-war-dev"
}

resource "aws_iam_policy_attachment" "S3-whalekit-yes-dev-replays" {
  name       = "S3-whalekit-yes-dev-replays"
  policy_arn = "arn:aws:iam::633944440063:policy/S3-whalekit-yes-dev-replays"
}

resource "aws_iam_policy_attachment" "SNS" {
  name       = "SNS"
  policy_arn = "arn:aws:iam::633944440063:policy/SNS"
}

resource "aws_iam_policy_attachment" "SQS" {
  name       = "SQS"
  policy_arn = "arn:aws:iam::633944440063:policy/SQS"
}
...
resource "aws_iam_policy_attachment" "TAGGING-infra" {
  name       = "TAGGING-infra"
  policy_arn = "arn:aws:iam::633944440063:policy/TAGGING-infra"
  roles      = ["ec2-infra"]
}

resource "aws_iam_policy_attachment" "TagGovernancePolicy" {
  name       = "TagGovernancePolicy"
  policy_arn = "arn:aws:iam::aws:policy/aws-service-role/TagGovernancePolicy"
}
...
resource "aws_iam_policy_attachment" "Tags" {
  name       = "Tags"
  policy_arn = "arn:aws:iam::633944440063:policy/Tags"
}
...
resource "aws_iam_policy_attachment" "WAR-Admin-Cloudwatch" {
  name       = "WAR-Admin-Cloudwatch"
  policy_arn = "arn:aws:iam::633944440063:policy/WAR-Admin-Cloudwatch"
  roles      = ["war-admin"]
}

resource "aws_iam_policy_attachment" "WAR-Admin-Gamelift" {
  name       = "WAR-Admin-Gamelift"
  policy_arn = "arn:aws:iam::633944440063:policy/WAR-Admin-Gamelift"
  roles      = ["war-admin"]
}
...
resource "aws_iam_policy_attachment" "ebs-gat-dev-rw" {
  name       = "ebs-gat-dev-rw"
  policy_arn = "arn:aws:iam::633944440063:policy/ebs-gat-dev-rw"
  users      = ["akozlov"]
}

resource "aws_iam_policy_attachment" "ingressController-iam-policy" {
  name       = "ingressController-iam-policy"
  policy_arn = "arn:aws:iam::633944440063:policy/ingressController-iam-policy"
  roles      = ["war-dev-gameplay-node"]
}

resource "aws_iam_policy_attachment" "kinesis-dev" {
  name       = "kinesis-dev"
  policy_arn = "arn:aws:iam::633944440063:policy/kinesis-dev"
  users      = ["kinesis-dev"]
}

resource "aws_iam_policy_attachment" "quicksightpolicy2" {
  name       = "quicksightpolicy2"
  policy_arn = "arn:aws:iam::633944440063:policy/quicksightpolicy2"
  users      = ["quicksight-user"]
}

resource "aws_iam_policy_attachment" "s3-gamelift" {
  name       = "s3-gamelift"
  policy_arn = "arn:aws:iam::633944440063:policy/s3-gamelift"
  roles      = ["s3-gamelift"]
}

resource "aws_iam_policy_attachment" "s3_access_to_prod_4_qs" {
  name       = "s3_access_to_prod_4_qs"
  policy_arn = "arn:aws:iam::633944440063:policy/s3_access_to_prod_4_qs"
  users      = ["quicksight-user"]
}

resource "aws_iam_policy_attachment" "s3_dev-reports-02_add_and_del" {
  name       = "s3_dev-reports-02_add_and_del"
  policy_arn = "arn:aws:iam::633944440063:policy/s3_dev-reports-02_add_and_del"
  roles      = ["prod_access_2_s3_dev-reports-02"]
}

resource "aws_iam_policy_attachment" "s3access4stardustdeploy" {
  name       = "s3access4stardustdeploy"
  policy_arn = "arn:aws:iam::633944440063:policy/s3access4stardustdeploy"
  users      = ["stardust-deploy"]
}

resource "aws_iam_policy_attachment" "start-pipeline-execution-war-dev" {
  name       = "start-pipeline-execution-war-dev"
  policy_arn = "arn:aws:iam::633944440063:policy/service-role/start-pipeline-execution-war-dev"
  roles      = ["cwe-role-war-dev"]
}

resource "aws_iam_policy_attachment" "yes-dev-aio-access-2-s3-bucket" {
  name       = "yes-dev-aio-access-2-s3-bucket"
  policy_arn = "arn:aws:iam::633944440063:policy/yes-dev-aio-access-2-s3-bucket"
  roles      = ["gluon-asu"]
}
